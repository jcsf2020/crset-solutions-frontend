...
export default function Testimonials() {
  const items = [
    {
      quote:
        "Em 30 dias duplicamos a taxa de conversao do funil. Execucao limpa e previsivel.",
      author: "Andre M.",
      role: "COO, SaaS B2B",
      metric: "+37% leads",
    },
    {
      quote:
        "Onboarding em 1 semana e pipe organizado. Dashboards que a equipa usa todos os dias.",
      author: "Beatriz R.",
    ...
    {
      quote:
        "Integracoes sem drama e SLAs cumpridos. Finalmente previsibilidade na captacao.",
      author: "Tiago L.",
      ...
      <div className="container-pro">
        <div className="mb-8 md:mb-10">
          ...
          <h2 className="mt-3 text-2xl md:text-3xl font-semibold tracking-tight">
            Resultados consistentes, sem ruido
          </h2>
          <p className="muted mt-2 max-w-prose">
            Casos reais com impacto em conversao, CPL e time-to-value.
          </p>
        </div>
            ...
            <article key={t.author} className="card p-6 md:p-7 relative">
              <header className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2 text-xs">
                  <Stars />
                  <span className="px-2 py-0.5 rounded-full border border-black/10 bg-white">
                    Verificado
                  </span>
                </div>
...
function Stars() {
  // 5 estrelas solidas em SVG (sem libs externas)
  return (
