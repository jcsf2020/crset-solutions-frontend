...
function Card({ plan }: { plan: Plan }) {
  return (
    <div
      className={`card p-6 md:p-7 flex flex-col justify-between relative ${
        plan.recommended ? "ring-1 ring-black/10" : ""
      }`}
    ...
    >
      ...
      <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-2">
        <Link href="/start" className="btn-primary px-4 py-2 text-center">
          Comecar agora
        </Link>
        <a
      ...
      <p className="text-[11px] muted mt-4">
        * Integracoes sujeitas a configuracao.
      </p>
    </div>
  );
}
      ...
      <div className="container-pro">
        <header className="text-center max-w-2xl mx-auto mb-10 md:mb-14">
          ...
          <p className="muted mt-3">
            Escolhe o plano certo para o teu momento. Upgrade facil quando
            estiveres pronto para escalar.
          </p>
        </header>
