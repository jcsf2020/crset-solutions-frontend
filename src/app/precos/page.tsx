...
const tiers: Tier[] = [
  { name: 'Essencial',   price: 'EUR 29/mes',  slug:'essencial',
    features: ['Landing + Captação', 'Leads básicas', 'Email SDR lite'] },
  ...
  { name: 'Enterprise',   price: 'EUR 199/mes', slug:'enterprise',
    features: ['White-label', 'SLA & SSO', 'Integrações custom', 'Relatórios avançados'] },
];

export default function PreçosPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <h1 className="text-3xl md:text-5xl font-semibold">Planos & Preços</h1>
      ...
      <p className="text-xs opacity-60 mt-6">* Integrações sujeitas a configuração.</p>
    </div>
  );
}
