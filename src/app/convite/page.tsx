    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="glass-card mb-8">
          <h2 className="text-3xl font-bold text-blue-400 mb-8 text-center">ñ Conhece as Nossas Mascotes AGI</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="crset-glass-card p-6 text-center hover:transform hover:-translate-y-2 transition-all duration-300">
              ...
              <p className="text-blue-300 font-semibold mb-2">Seguranca & Automacao</p>
            ...
            <div className="crset-glass-card p-6 text-center hover:transform hover:-translate-y-2 transition-all duration-300">
              ...
              <p className="text-orange-300 font-semibold mb-2">Comunicacao & Organizacao</p>
              <p className="text-gray-300 text-sm">
        ...
        <div className="glass-card mb-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="crset-glass-card p-6">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Seguranca Garantida</h3>
              <p className="text-gray-300 text-sm">
        ...
        <div className="glass-card mb-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Å Acesso Beta Gratuito</h2>
        ...
        <div className="glass-card mb-8">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            <div className="crset-glass-card p-6">
              <div className="text-4xl mb-4">µπ</div>
        ...
        <div className="text-center py-8">
          ...
          <p className="text-gray-500 text-sm mb-4">
            Inteligencia Artificial para Negocios - Portugal
          </p>
