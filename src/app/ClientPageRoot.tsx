      ...
      {showDiscount && (
        <div className="hidden fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
          <div className="bg-gradient-to-br from-purple-600 to-purple-800 rounded-2xl p-8 max-w-md w-full relative">
            <a href="/#contato" className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-8 py-3 text-lg rounded-lg transition-all duration-200 font-semibold">Começar Agora ⚡</a>
